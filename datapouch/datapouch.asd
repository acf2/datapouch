...
(defsystem datapouch
  ...
  :components ((:file "packages")
               ...
               (:file "regex-support/ppcre-trees" :depends-on ("packages" "interface"))
               (:file "regex-support/main" :depends-on ("packages" "interface" "regex-support/types" "regex-support/ppcre-trees"))
